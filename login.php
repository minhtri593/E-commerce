...
if(isset($_POST['login'])){
  include "includes/config.php";
    ...
    $sql = "SELECT  customer_id, customer_email, customer_pwd, customer_role FROM customer WHERE customer_email = '{$email}' AND customer_pwd= '{$password}'";
    ...
    if($result->num_rows==1){ //if any one data found go inside it
        ...
        if($_POST['email2']){ //it means it will run if email field is filled
