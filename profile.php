...
//for edit backend users data php and mysql
      ...
      if (isset($_SESSION['id'])) {
        // You can use the session ID to display user profile
        $userId = $_SESSION['id'];
        // Fetch user details from the database and display
        // Example: $sql = "SELECT * FROM customer WHERE customer_id = $userId";
    } else {
        // If no session found, redirect to login or unauthorized page
