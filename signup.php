...
<html lang="en">
  ...
  <body>
    ...
    <?php
// Check if there's an error parameter in the URL and display the message
if (isset($_GET['error']) && $_GET['error'] == 'enterValidNumber') {
    echo "<p style='color: red;'>Phone number is not valid. Please enter a valid number.</p>";
}
if (isset($_GET['error']) && $_GET['error'] == 'enterValidNumber') {
  echo "<p style='color: red;'>Email is not valid. Please enter a valid email.</p>";
}
?>
